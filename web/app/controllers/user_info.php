...
<?php else: ?>
	<?php echoUOJPageHeader('Użytkownik nie istnieje' . ' - Informacje o użytkowniku') ?>
	<div class="card border-danger">
		<div class="card-header bg-danger">Informacje o użytkowniku</div>
		<div class="card-body">
		<h4>Użytkownik nie istnieje</h4>
		</div>
	</div>
<?php endif ?>
