...
?>
<?php echoUOJPageHeader(HTML::stripTags($problem['title']) . ' - Edytuj - Zarządzaj zadaniem') ?>
<h1 class="page-header" align="center">Zarządzaj #<?=$problem['id']?> : <?=$problem['title']?></h1>
<ul class="nav nav-tabs" role="tablist">
	<li class="nav-item"><a class="nav-link active" href="/problem/<?= $problem['id'] ?>/manage/statement" role="tab">Edytuj</a></li>
